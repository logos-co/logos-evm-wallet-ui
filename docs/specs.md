...
| 6 | **Advanced** | chain id / name / RPC URL / symbol fields, **Test endpoint**, **Save chain**; seed phrase + passphrase, **Import** | `chainsJson` | `testEndpoint`, `setChains`, `importMnemonic` |
