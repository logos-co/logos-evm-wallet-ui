...
Item {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Label { text: "Logos Wallet"; font.pixelSize: 22; font.bold: true; Layout.topMargin: 10 }
            Label {
            ...
            // ── Accounts ──
            Label { text: "Accounts"; font.bold: true; Layout.topMargin: 6 }
            RowLayout {
            ...
            // ── Send ──
            Label { text: "Send"; font.bold: true; Layout.topMargin: 6 }
            ...
            // ── History ──
            Label { text: "History"; font.bold: true; Layout.topMargin: 6 }
            Repeater {
                model: root.history
                Label {
            ...
            // ── Settings (privacy / proxy) ──
            Label { text: "Privacy / proxy"; font.bold: true; Layout.topMargin: 6 }
            ...
            Label {
                Layout.fillWidth: true; Layout.topMargin: 8; Layout.bottomMargin: 10
